...
PRICING: dict[str, ModelPricing] = {
    ...
    # DeepSeek Flash — same $0.14/$0.28 per 1M input/output as V4 Flash
    # (verified live 2026-09-25). TO-CONFIRM against provider bill.
    "deepseek-flash": ModelPricing(input_per_1m=0.14, output_per_1m=0.28),
